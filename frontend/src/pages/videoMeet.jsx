...
import { Badge, Button, TextField, IconButton } from '@mui/material';
...
export default function VideoMeetComponent() {
    ...
    //function if I stop the video then on all computers it must stop
    ...
    const addMessage = (data, sender, socketIdSender) => {
        console.log("hI");
        console.log("Received message: ", data, "Sender: ", sender, "Socket ID Sender: ", socketIdSender);
                        ...
                        <div className={styles.conferenceView}>
                            {videos.map((video) => (
                                <div key={video.socketId}>
                                    <video className={styles.conferenceViewVideo} data-socket={video.socketId}
                                        ref={ref => {
                                            if (ref && video.stream) {
